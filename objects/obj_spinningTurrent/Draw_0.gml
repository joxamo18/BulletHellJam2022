...
if (in_combat)
{
	...
	draw_sprite_ext(spr_health_background, 1, healthbar_background_x + lengthdir_x(0, direction), healthbar_background_y + lengthdir_y(0, direction), 1, 1, direction, c_gray, 1)
